...
Vue.component('font-awesome-icon', async () => {
	...
	const icons = await Promise.all([
		...
		import('@lincebi/biserver-frontend-common/src/fontawesome/faFileAdhoc'),
		import('@lincebi/biserver-frontend-common/src/fontawesome/faFileCda'),
		import('@lincebi/biserver-frontend-common/src/fontawesome/faFileCdfde'),
		import('@lincebi/biserver-frontend-common/src/fontawesome/faFilePdf'),
		...
		import('@lincebi/biserver-frontend-common/src/fontawesome/faFileXcdf'),
		import('@lincebi/biserver-frontend-common/src/fontawesome/faFileXjpivot'),
		import('@lincebi/biserver-frontend-common/src/fontawesome/faFileXml'),
		import('@lincebi/biserver-frontend-common/src/fontawesome/faToolCde'),
		import('@lincebi/biserver-frontend-common/src/fontawesome/faToolStadmin'),
