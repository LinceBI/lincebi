...
Vue.component('font-awesome-icon', async () => {
	...
	const icons = await Promise.all([
		...
		import('@lincebi/biserver-customization-common/src/fontawesome/faFileAdhoc'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faFileCda'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faFileCdfde'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faFilePdf'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faFilePrpt'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faFileSta'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faFileStd'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faFileUrl'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faFileWcdf'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faFileXaction'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faFileXcdf'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faFileXjpivot'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faFileXml'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faToolCde'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faToolStadmin'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faToolStagile'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faToolStcard'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faToolStdashboard'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faToolStpivot'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faToolStreport'),
		import('@lincebi/biserver-customization-common/src/fontawesome/faToolStsearch')
		/* eslint-enable */
	]);
