...
dependencies {
	...
	compileOnly("org.pentaho:commons-database-model:8.3.0.22-1241") { isTransitive = false }
	compileOnly("org.pentaho:pentaho-metadata:8.3.0.22-1241") { isTransitive = false }
	...
	compileOnly("pentaho:pentaho-platform-extensions:8.3.0.22-1241") { isTransitive = false }
	compileOnly("pentaho:pentaho-platform-repository:8.3.0.22-1241") { isTransitive = false }
