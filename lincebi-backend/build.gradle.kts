...
dependencies {
	...
	compileOnly("pentaho:pentaho-platform-extensions:9.3.0.9-874") { isTransitive = false }
	compileOnly("pentaho:pentaho-platform-repository:9.3.0.9-874") { isTransitive = false }
