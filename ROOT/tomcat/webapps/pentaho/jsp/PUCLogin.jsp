...
<style type="text/css">
  ...
  .pentaho-dialog#dialogOverrideFile,.pentaho-dialog#dialogOverrideFolder, .pentaho-dialog#dialogRename {
...
.bootstrap h1, .bootstrap h2, .bootstrap h3, .bootstrap h4, .bootstrap h5, .bootstrap h6 {
    ...
    line-height: 20px;
    color: #3c7a21 !important;
    text-rendering: optimizelegibility;
    font-weight: normal;
}
.bootstrap .btn{
  background: #679f33 !important;
  color:white;
}
.pentaho-page-background {
  background: url(/pentaho/content/common-ui/resources/themes/stratebi/images/bg2.png) 100% 100% !important;
...
<body class="pentaho-page-background" style="    overflow: hidden;">
...
%>
  ...
  <div id="login-footer-wrapper">
    <div id="login-footer" class="afterSlide"><%=Messages.getInstance().getString("UI.PUC.LOGIN.COPYRIGHT", String.valueOf(year))%></div>
  </div>
</div>
