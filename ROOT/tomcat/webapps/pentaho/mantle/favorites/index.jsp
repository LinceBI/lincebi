...
<body>
    ...
    <div id="main-container">
        ...
        <div id="header" class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
					<h2 class="section-title"><%= customProperties.getString("favorites") %></h2>
				</div>
			</div>
		</div>
						...
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-2 flex-column">
									<button class="btn btn-primary" id="reload" onclick="populateFavorites()">
										<span class="fa fa-refresh"></span>
									</button>
								</div>
							</div>
						</div>
						<div id="favorites-panel" class="list-group">
						</div>
					</div>
                </div>
            </div>
