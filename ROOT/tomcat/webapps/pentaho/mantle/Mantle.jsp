...
<body oncontextmenu="return false;" class="pentaho-page-background">
  ...
  <div ng-show="viewContainer === 'PUC'" 
    ...
    <div id="pucHeader" cellspacing="0" cellpadding="0">
      ...
      <div class="pucProfile1 col-md-3">
...
<ul>
   ...
   <li class='' onclick="window.parent.mantle_setPerspective('browser.perspective')"><a href='#'> <i class="fa fa-folder-open" aria-hidden="true"></i></a></li>
   <li class='' onclick="window.parent.mantle_setPerspective('search.perspective')"><a href='#'><i class="fa fa-search" aria-hidden="true"></i></a></li>
   <li class='' onclick="window.top.mantle_setPerspective('administration.perspective')"><a href='#'><i class="fa fa-unlock-alt" aria-hidden="true"></i></a></li>  
   <li class='active'><a href='#' style="padding: 12px 12px;font-size: 12px;">[ES]</a>
      <ul>
         <li><a href='#'><div onclick='' class="btn btn-large btn-block">[ ES ]</div>    </a>         </li>
         <li><a href='#'><div onclick='' class="btn btn-large btn-block">[ EN ]</div>    </a>         </li>
         <li><a href='#'><div onclick='' class="btn btn-large btn-block">[ FR ]</div>    </a>         </li>
         <li><a href='#'><div onclick='' class="btn btn-large btn-block">[ ITA ]</div>    </a>         </li>
         <li><a href='#'><div onclick='' class="btn btn-large btn-block">[ PR ]</div>    </a>         </li>
      </ul>
   </li>

   <li class=''><a href='/pentaho/Logout'><i class="fa fa-sign-out" aria-hidden="true"></i></a></li>
